...
if [ "$MODE" = "dev" ]; then
  ...
  DATA_PLANE_REMOTE_REPO=https://github.com/wintech-thai/please-protect-brain-data-plane.git
  CTRL_PLANE_REMOTE_REPO=https://github.com/wintech-thai/please-protect-brain-control-plane.git
